...
MANIFEST_PATH="${MANIFEST_PATH:-sample-cases/SAMPLE_CASES_MANIFEST.v1.yaml}"
RECEIPT_BASENAME="${RECEIPT_BASENAME:-sample-cases-manifest.diff}"
...
CHECKSUM_PATH="receipts/${RECEIPT_BASENAME}.sha256"
BUNDLE_PATH="receipts/${RECEIPT_BASENAME}.sigstore.json"

# Emit a deterministic payload. If the manifest did not change, this is an empty file.
